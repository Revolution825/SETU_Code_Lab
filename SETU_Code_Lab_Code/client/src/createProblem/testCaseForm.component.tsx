...
export default function TestCaseForm({ testCases, setTestCases }: Props) {
  const getTestCaseId = (tc: TestCase): number | string =>
    tc.test_case_id ?? tc.temp_id!;
  const addTestCase = () => {
    setTestCases((prev) => [
      ...prev,
      {
            ...
            <div key={id} className="testCaseBackground">
              ...
              <div className="createProblemInput">
                ...
                <input
                  ...
                  onChange={(e) => {
                    updateTestCase(id, "input_value", e.target.value);
                  }}
                  required
                />
              </div>
              <div className="createProblemInput">
                <label style={{ marginLeft: 32 }}>Expected Output:</label>
                <input
                  ...
                  onChange={(e) => {
                    updateTestCase(id, "expected_value", e.target.value);
                  }}
                  required
                />
              </div>
